...
const DOMAINS: MindNode[] = [
  ...
  { id: "cricket",     label: "Cricket",     x: 660, y: 375, r: 20, color: "#3B82F6", href: "/blog/ipl-analytics",
...
const CHILDREN: MindNode[] = [
  ...
  // Cricket
  { id: "ipl",      parentId: "cricket", label: "IPL Data",   x: 762, y: 320, r: 11, color: "#3B82F6", href: "/blog/ipl-analytics",
    desc: "Phase-weighted batting impact. Death bowling undervalued everywhere." },
  { id: "xgboost",  parentId: "cricket", label: "XGBoost",   x: 768, y: 430, r: 11, color: "#3B82F6", href: "/blog/ipl-analytics",
    desc: "67.3% match prediction accuracy on IPL 2024. 17.3pp above baseline." },
  { id: "phases",   parentId: "cricket", label: "Phase Theory", x: 658, y: 465, r: 11, color: "#3B82F6", href: "/blog/ipl-analytics",
...
const DOMAIN_INFO: Record<string, { title: string; lines: string[]; cta: string; ctaHref: string }> = {
  ...
  cricket: {
    ...
    cta: "Read the IPL analytics post →",
    ctaHref: "/blog/ipl-analytics",
  },
  code: {
    title: "Code",
    lines: [
